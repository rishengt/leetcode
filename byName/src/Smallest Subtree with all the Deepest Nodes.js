...
var dfs = function(root){
    ...
    return l[1]>r[1]?[l[0],depth]:l[1]===r[1]?[root,depth]:[r[0],depth];
}

let root = new TreeNode(3);
root.left = new TreeNode(5);root.right = new TreeNode(1);root.right.left = new TreeNode(0);root.right.right = new TreeNode(8);
